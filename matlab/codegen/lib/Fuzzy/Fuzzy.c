 ...
 *                double e_l_k_1
 *                double theta_m_d_k_1
 *                double Kp
 *                double Kd
 *                double Ku
 *                double T
 *                double theta_m_d_upper_limit
 *                double theta_m_d_lower_limit
 * Return Type  : double
 */
double Fuzzy(double e_l_k, double e_l_k_1, double theta_m_d_k_1, double Kp,
             double Kd, double Ku, double T, double theta_m_d_upper_limit,
             double theta_m_d_lower_limit)
{
  double theta_m_d;
  double e;
