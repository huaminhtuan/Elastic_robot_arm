...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function theta_m_d = Fuzzy(e_l_k, e_l_k_1, theta_m_d_k_1)
    assert(isa(e_l_k,'double') && isa(e_l_k_1,'double')...
        && isa(theta_m_d_k_1,'double'));
%%%%%%%%% Local variable %%%%%%%%%
    Kp = 1;
    Kd = 1;
    Ku = 1;
...
%%%%%%%%% Postprocessing %%%%%%%%%
    theta_m_d = u*T + theta_m_d_k_1;
    theta_m_d = theta_m_d*Ku;
    % Saturation
    if theta_m_d > theta_m_d_upper_limit
        theta_m_d = theta_m_d_upper_limit;
    elseif theta_m_d < theta_m_d_lower_limit
